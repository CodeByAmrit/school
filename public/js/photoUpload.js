document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    formData.append(
      "father_name",
      document.getElementById("father_name").value.toUpperCase(),
    );
    formData.append(
      "mother_name",
      document.getElementById("mother_name").value.toUpperCase(),
    );
    formData.append(
      "srn_no",
      document.getElementById("srn_no").value.toUpperCase(),
    );
    formData.append(
      "pen_no",
      document.getElementById("pen_no").value.toUpperCase(),
    );
    formData.append(
      "admission_no",
      document.getElementById("admission_no").value.toUpperCase(),
    );
    formData.append(
      "roll_no",
      document.getElementById("roll_no").value.toUpperCase(),
    );
    formData.append(
      "class",
      document.getElementById("class").value.toUpperCase(),
    );
    formData.append(
      "session",
    ...
    formData.append(
      "permanent_address",
      document.getElementById("permanent_address").value.toUpperCase(),
    );
    formData.append(
      "corresponding_address",
      document.getElementById("corresponding_address").value.toUpperCase(),
    );
    formData.append(
      "paste_file_no",
      document.getElementById("paste_file_no").value.toUpperCase(),
    );
    formData.append(
      "mobile_no",
      document.getElementById("mobile_no").value.toUpperCase(),
    );
    formData.append(
      "family_id",
      document.getElementById("family_id").value.toUpperCase(),
    );
    formData.append("dob", document.getElementById("dob").value.toUpperCase());
    formData.append(
      "profile_status",
      document.getElementById("profile_status").value.toUpperCase(),
    );
    formData.append(
      "apaar_id",
      document.getElementById("apaar_id").value.toUpperCase(),
    );
    formData.append(
      "gender",
    ...
    formData.append(
      "father_aadhar_no",
      document.getElementById("father_aadhar_no").value,
    );
    formData.append(
      "mother_aadhar_no",
      document.getElementById("mother_aadhar_no").value,
    );

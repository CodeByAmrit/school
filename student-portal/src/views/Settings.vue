      ...
      <div class="space-y-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500">
              Enable dark mode for the interface (Not fully implemented)
            </p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500">
              Receive email alerts for new results and documents
            </p>
          </div>
          <button
...
const toggleTheme = () => {
  studentStore.settings.theme =
    studentStore.settings.theme === "dark" ? "light" : "dark";
};

const toggleNotifications = () => {
  studentStore.settings.notifications_enabled =
    !studentStore.settings.notifications_enabled;
};

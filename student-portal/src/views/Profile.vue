<template>
  <div class="space-y-6">
    ...
    >
      <div>
        <h1
          class="text-3xl font-bold bg-gradient-to-r from-[#63b3ed] to-[#3182ce] bg-clip-text text-transparent"
        >
          My Profile
        </h1>
    ...
    <div v-if="studentStore.loading.profile" class="mt-8">
      <div class="flex flex-col items-center justify-center py-12">
        <div class="relative">
          <div
            class="w-20 h-20 rounded-full bg-gradient-to-r from-blue-100 to-blue-50 border-4 border-blue-50 animate-pulse"
          ></div>
    ...
    <div v-else-if="profile" class="space-y-6">
      ...
      >
        ...
        <div class="relative">
          <!-- Background Gradient -->
          <div
            class="absolute inset-0 bg-gradient-to-r from-blue-50 via-white to-blue-50"
          ></div>

          <div
            class="relative px-8 py-6 flex flex-col md:flex-row md:items-center gap-6"
          >
            <!-- Profile Photo -->
            <div class="relative group">
              <div
                class="relative w-32 h-32 rounded-2xl overflow-hidden border-4 border-white shadow-xl"
              >
                <div
                  v-if="!profile.photo"
                  class="w-full h-full bg-gradient-to-br from-[#63b3ed] to-[#3182ce] flex items-center justify-center"
                >
              ...
              <!-- Online Status Badge -->
              <div
                class="absolute -bottom-2 -right-2 w-6 h-6 rounded-full bg-green-500 border-4 border-white shadow-lg"
              ></div>

              <!-- Upload Overlay -->
              <div
                class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300 flex items-center justify-center"
              >
                <button
                  class="p-2 rounded-full bg-white/80 hover:bg-white transition-colors duration-300"
                >
              ...
              >
                <div>
                  ...
                  <div class="flex items-center gap-4 mt-2">
                    ...
                    <span
                      class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 text-green-700 text-sm font-medium"
                    >
                ...
                <div class="hidden lg:block">
                  <div
                    class="p-3 rounded-xl bg-gradient-to-br from-blue-50 to-white border border-blue-200"
                  >
                    <div class="text-center">
                      <div
                        class="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center mb-2"
                      >
          ...
          <div class="mt-8">
            ...
            <div v-if="activeTab === 'personal'" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Contact Information -->
                <div
                  class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-100"
                >
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-3">
                      <div
                        class="w-10 h-10 rounded-lg bg-white border border-blue-100 flex items-center justify-center"
                      >
                ...
                <!-- Family Information -->
                <div
                  class="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 border border-purple-100"
                >
                  <div class="flex items-center gap-3 mb-6">
                    <div
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-3">
                      <div
                        class="w-10 h-10 rounded-lg bg-white border border-purple-100 flex items-center justify-center"
                      >
              ...
              <div
                class="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 border border-gray-100"
              >
                <div class="flex items-center gap-3 mb-6">
                  <div
            ...
            <div v-else-if="activeTab === 'academic'" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <div class="mt-4 flex items-center gap-2">
                    <div
                      class="flex-1 h-2 bg-blue-100 rounded-full overflow-hidden"
                    >
                      <div
                        class="h-full bg-gradient-to-r from-[#63b3ed] to-[#3182ce] rounded-full"
                        style="width: 90%"
                      ></div>
                    </div>
                ...
                <div
                  class="bg-gradient-to-br from-green-50 to-white rounded-xl p-6 border border-green-100"
                >
                  <div class="flex items-center justify-between">
                    <div>
                  ...
                  <div class="mt-4 flex items-center gap-2">
                    <div
                      class="flex-1 h-2 bg-green-100 rounded-full overflow-hidden"
                    >
                      <div
                ...
                >
                  ...
                  <div class="mt-4 flex items-center gap-2">
                    <div
                      class="flex-1 h-2 bg-purple-100 rounded-full overflow-hidden"
                    >
                      <div
              ...
              <!-- Current Subjects -->
              <div
                class="bg-gradient-to-br from-white to-gray-50 rounded-xl p-6 border border-gray-200"
              >
                ...
                >
                  ...
                  >
                    <div class="flex items-center justify-between mb-2">
                      ...
                      <span
                        class="text-sm font-medium px-2 py-1 rounded-full bg-blue-100 text-blue-700"
                      >
                        {{ subject.code }}
                      </span>
                    </div>
            ...
            <div v-else-if="activeTab === 'documents'" class="space-y-6">
              <!-- Upload Area -->
              <div
                class="border-2 border-dashed border-blue-200 rounded-2xl p-8 text-center hover:border-blue-300 hover:bg-blue-50 transition-all duration-300"
              >
                <div
                ...
                <button
                  class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#63b3ed] to-[#3182ce] text-white rounded-lg hover:opacity-90 transition-opacity duration-300"
                >
                ...
                <div class="divide-y divide-gray-200">
                  ...
                  >
                    <div class="flex items-center justify-between">
                      ...
                      <div class="flex items-center gap-2">
                        <button
                          class="p-2 rounded-lg hover:bg-blue-100 text-blue-600 transition-colors duration-300"
                        >
    ...
    <div v-else class="text-center py-12">
      <div
        class="w-20 h-20 rounded-full bg-gradient-to-r from-red-100 to-red-50 border-4 border-red-50 flex items-center justify-center mx-auto"
      >
...
const subjects = computed(() => {
  ...
  const latestTerm = Array.isArray(results.value)
  ...
  return latestTerm.subjects.map((sub) => ({
    ...
    progress: sub.obtained_marks
      ? Math.round((sub.obtained_marks / sub.total_marks) * 100)
      : 0,
